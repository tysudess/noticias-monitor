...
private fun VideoEditorHeader() {
    Surface(color = VEPanel, shape = RoundedCornerShape(14.dp), border = BorderStroke(1.dp, VEBorder), modifier = Modifier.fillMaxWidth()) {
        Row(Modifier.padding(horizontal = 16.dp, vertical = 12.dp), verticalAlignment = Alignment.CenterVertically) {
            ...
            Button(onClick = {}, colors = ButtonDefaults.buttonColors(containerColor = VEPurple)) {
...
private fun VideoTimelineShell() {
    Surface(color = VEPanel, shape = RoundedCornerShape(14.dp), border = BorderStroke(1.dp, VEBorder), modifier = Modifier.fillMaxWidth().height(205.dp)) {
        Column(Modifier.fillMaxSize().padding(13.dp)) {
            ...
            Box(Modifier.weight(1f).fillMaxWidth().background(VEPanel2, RoundedCornerShape(9.dp)), contentAlignment = Alignment.Center) {
...
private fun VideoExportShell() {
    Surface(color = VEPanel, shape = RoundedCornerShape(14.dp), border = BorderStroke(1.dp, VEBorder), modifier = Modifier.fillMaxWidth().height(104.dp)) {
...
private fun VideoTimeField(label: String, value: String) {
    Column {
        ...
        Surface(color = VEPanel2, shape = RoundedCornerShape(8.dp), border = BorderStroke(1.dp, VEBorder), modifier = Modifier.fillMaxWidth()) {
